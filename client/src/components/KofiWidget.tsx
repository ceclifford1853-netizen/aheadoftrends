...
const KofiWidget: React.FC<{ type: 'button' | 'shop' | 'commission' }> = ({ type }) => {
  ...
  if (type === 'shop') {
    return (
      <div className="flex justify-center my-8">
        <a href={`${kofiPageUrl}?tab=shop`} target="_blank" rel="noopener noreferrer">
  ...
  return (
    <div className="flex justify-center my-8">
      <a href={`${kofiPageUrl}?tab=commissions`} target="_blank" rel="noopener noreferrer">
